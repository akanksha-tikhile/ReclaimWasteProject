...
<title>Register to Recycle</title>
			...
			<div class="container">
				<div class="recycle-content">
					<div class="recycle-form">
						<h2 class="form-title">Register to Recycle</h2>
					
						<form method="post" action="Recycle" class="RecycleServlet-form"
							id="RecycleServlet-form">
							<div class="mb-4">
                             ...
                             <hr>
                                ...
                                <hr>
                                 <div class="mb-4">
                                <label>Process  : </label>
                                <input type="checkbox" name="process" id="process" value="Recycle" required>Recycle
                             </div>
                                <hr>
